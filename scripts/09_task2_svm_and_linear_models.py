...
TASK_NAME = "Task 2: SVM and linear model baselines"
...
def main():
    ...
    experiments = get_linear_experiments()
    ...
    out_summary = OUT_DIR / "task2_svm_linear_summary.csv"
    out_folds = OUT_DIR / "task2_svm_linear_fold_results.csv"
